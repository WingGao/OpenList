...
## Purpose
The system SHOULD allow for rapid file uploads using hash-based object lookup, where a file's content is reused if it already exists on the storage provider's side.
